...
def cklog(server):
   ...
   ###except pexpect.TIMEOUT:
	###print "Fail to install ssh key to %s" % server
	    ...
	    child.expect('s00c0')  ## It's very strange: if expect('/export/home/lss'), no output can be saved to logfile except the sent command!!!! Because '/export/home/lss' is a part of the sent command!!! pexpect thinks it has already match it when sending the command
	    #child.expect('/export/home/lss')
